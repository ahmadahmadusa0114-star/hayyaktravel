...
export function Footer({ locale }: FooterProps) {
    ...
    const quickLinks = [
        ...
        { name: t.nav.trips, href: `/${locale}/trips` },
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className={`flex flex-col ${isRTL ? 'items-end' : 'items-start'}`}>
                                ...
                                <span className="text-xs text-gray-400">
                                    {isRTL ? 'للسياحة والسفر' : 'Travel & Tourism'}
                                </span>
                            </div>
                        </div>
                        <p className="text-sm text-gray-400 mb-4">
                            {isRTL
                                ? 'نقدم أفضل الخدمات السياحية والرحلات المميزة إلى جميع أنحاء العالم'
                                : 'We provide the best travel services and exceptional trips to all parts of the world'}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center gap-2">
                                ...
                                <a href="tel:+962790000000" className="text-sm text-gray-400 hover:text-white transition-colors" dir="ltr">
                                    +962 79 000 0000
                                </a>
                            </li>
                            <li className="flex items-center gap-2">
                                ...
                                <a href="mailto:info@hayyakgroup.com" className="text-sm text-gray-400 hover:text-white transition-colors">
                                    info@hayyakgroup.com
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-gray-800 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-gray-400">
                            © {currentYear} {isRTL ? 'حياك للسياحة والسفر' : 'HAYYAK Travel & Tourism'}. {t.footer.rights}.
                        </p>
